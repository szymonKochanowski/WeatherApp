...
public class GeolocationService {
    ...
    public GeolocationDto addNewGeolocationBasedOnWeather(WeatherDto weatherDto) throws Exception {
        log.info("Start to add new geolocation for city: " + weatherDto.city());
        try {
            Geolocation geolocation = new Geolocation();
            geolocation.setCity(weatherDto.city());
            geolocation.setCountry(weatherDto.country());
            geolocation.setLatitude(weatherDto.latitude());
            geolocation.setLongitude(weatherDto.longitude());
